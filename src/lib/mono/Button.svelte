<script module lang="ts">
  ...
  export const buttonColor = {
    ...
    secondary: `border border-slate-200 border-b-slate-300 dark:border-zinc-800 dark:border-t-zinc-700/50 bg-white dark:bg-zinc-900
		hover:bg-zinc-100 hover:dark:bg-zinc-800 hover:dark:border-zinc-700 hover:dark:border-zinc-700 active:dark:bg-zinc-900 active:bg-zinc-200`,

    tertiary:
      'border border-transparent bg-transparent hover:bg-zinc-100 hover:dark:bg-zinc-700/30 dark:text-zinc-200',
    ...
    ghost: `border border-slate-200 dark:border-zinc-800 bg-transparent
		hover:bg-zinc-100 hover:dark:bg-zinc-800 hover:dark:border-zinc-700 dark:text-zinc-400 hover:text-inherit
		hover:dark:text-inherit`,

    elevated: `bg-zinc-100 dark:bg-zinc-800 border border-slate-200
	 dark:border-zinc-700 hover:bg-zinc-200 hover:dark:bg-zinc-700 hover:border-slate-300
	 hover:dark:border-zinc-600`,

    elevatedLow: `bg-zinc-100 dark:bg-zinc-900 border border-slate-200
	dark:border-zinc-800 hover:bg-zinc-200 hover:dark:bg-zinc-800 hover:border-slate-300
